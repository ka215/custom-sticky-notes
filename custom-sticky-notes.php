...
?>
<?php
define('CSNP_PLUGIN_VERSION', '1.0.0');
...
final class CustomStickyNotes {
  ...
  private function init() {
    ...
    // Languages
    $this->plugin_lang_dir = plugin_dir_path(__FILE__) . '/langs';
  ...
  private function setup_actions() {
    ...
    add_action( 'init', array($this, 'sticky_notes_actions') ); // Both admin panel and frontend.
   ...
   * @since 1.0.0
   */
  public function sticky_notes_actions() {
...
EOS;
   ...
   */
  public function ajax_event_save_usermeta( $args=[] ) {
